...
func NewOrbitControl(icam camera.ICamera, m *moblie.Moblie) *OrbitControl {
	...
	// Subscribe to events
	oc.moblie.Subscribe(moblie.SystemTouch, oc.onTouch)
...
func (oc *OrbitControl) onTouch(evname string, ev interface{}) {
