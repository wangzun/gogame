...
func (l *Spot) RenderSetup(gs *gls.GLS, rinfo *core.RenderInfo, idx int) {
	...
	data := []float32{
		...
		l.udata.direction.Y,
		l.udata.direction.Z,
		l.udata.angularDecay,   // float32        // Angular decay factor
		l.udata.cutoffAngle,    // float32        // Cut off angle
		l.udata.linearDecay,    // float32        // Distance linear decay
		l.udata.quadraticDecay, // float32        // Distance quadratic decay
		l.udata.dummy1,         //float32        // Completes 5*vec3
		l.udata.dummy2}         //float32
