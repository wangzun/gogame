...
type Geometry struct {
	...
	handleVAO gl.VertexArray  // Handle to OpenGL VAO
	indices   math32.ArrayU32 // Buffer with indices
	// handleIndices uint32            // Handle to OpenGL buffer for indices
	handleIndices gl.Buffer         // Handle to OpenGL buffer for indices
...
func (g *Geometry) SetVAO(handle gl.VertexArray) {

	g.handleVAO = handle
}

// VAO returns the Vertex Array Object handle associated with this geometry.
func (g *Geometry) VAO() gl.VertexArray {
