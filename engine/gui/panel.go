...
func (p *Panel) RenderSetup(gs *gls.GLS, rinfo *core.RenderInfo) {
	...
	gs.UniformMatrix4fv(gl.Uniform{Value: location}, 1, false, mm[:])
	...
	data := []float32{
		p.udata.bounds.X,        // math32.Vector4 // panel bounds in texture coordinates
		p.udata.bounds.Y,        // math32.Vector4 // panel bounds in texture coordinates
		p.udata.bounds.Z,        // math32.Vector4 // panel bounds in texture coordinates
		p.udata.bounds.W,        // math32.Vector4 // panel bounds in texture coordinates
		p.udata.borders.X,       // math32.Vector4 // panel borders in texture coordinates
		p.udata.borders.Y,       // math32.Vector4 // panel borders in texture coordinates
		p.udata.borders.Z,       // math32.Vector4 // panel borders in texture coordinates
		p.udata.borders.W,       // math32.Vector4 // panel borders in texture coordinates
		p.udata.paddings.X,      //      math32.Vector4 // panel paddings in texture coordinates
		p.udata.paddings.Y,      //      math32.Vector4 // panel paddings in texture coordinates
		p.udata.paddings.Z,      //      math32.Vector4 // panel paddings in texture coordinates
		p.udata.paddings.W,      //      math32.Vector4 // panel paddings in texture coordinates
		p.udata.content.X,       //       math32.Vector4 // panel content area in texture coordinates
		p.udata.content.Y,       //       math32.Vector4 // panel content area in texture coordinates
		p.udata.content.Z,       //       math32.Vector4 // panel content area in texture coordinates
		p.udata.content.W,       //       math32.Vector4 // panel content area in texture coordinates
		p.udata.bordersColor.R,  //  math32.Color4  // panel border color
		p.udata.bordersColor.G,  //  math32.Color4  // panel border color
		p.udata.bordersColor.B,  //  math32.Color4  // panel border color
		p.udata.bordersColor.A,  //  math32.Color4  // panel border color
		p.udata.paddingsColor.R, // math32.Color4  // panel padding color
		p.udata.paddingsColor.G, // math32.Color4  // panel padding color
		p.udata.paddingsColor.B, // math32.Color4  // panel padding color
		p.udata.paddingsColor.A, // math32.Color4  // panel padding color
		p.udata.contentColor.R,  // math32.Color4  // panel content color
		p.udata.contentColor.G,  // math32.Color4  // panel content color
		p.udata.contentColor.B,  // math32.Color4  // panel content color
		p.udata.contentColor.A,  // math32.Color4  // panel content color
		p.udata.textureValid,    //  float32        // texture valid flag (bool)
		p.udata.dummy[0],
		p.udata.dummy[1],
		p.udata.dummy[2],
	}
